...
$config['page_slug'] 	= 'prime-fashion-magazine';
...
$config['steps'] = array(
	'intro' => array(
		'id'			=> 'intro', 
		'title'			=> __( 'Welcome to ', 'prime-fashion-magazine' ) . $theme_title, // Section title
		'icon'			=> 'dashboard', 
		'can_skip'		=> false 
	),
	'plugins' => array(
	...
	'widgets' => array(
		...
		'button_text'	=> __( 'Import Demo', 'prime-fashion-magazine' ),
		'can_skip'		=> false
	),
	'done' => array(
		'id'			=> 'done',
