                ...
                <?php if (get_theme_mod('prime_fashion_magazine_post_layout_setting', 'right-sidebar') == 'one-column') { ?>              
                    <?php if ( have_posts() ) : ?>
                        ...
                        <header class="page-header">
                            <h1 class="page-title">
                                <?php printf( esc_html__( 'Search Results', 'prime-fashion-magazine' ) ); ?>
                            </h1>
                            ...
                            <p class="count">
                                <?php
                                printf(
                                    esc_html__( 'Search Results for "%s"', 'prime-fashion-magazine' ),
                    ...
                    <?php endif; ?>
                <?php } elseif (get_theme_mod('prime_fashion_magazine_post_layout_setting', 'right-sidebar') == 'grid-layout') { ?>
                    <div class="row">
                        <?php if (have_posts()) : ?>
                            <header class="page-header">
                                ...
                                printf(esc_html__('Search Results for "%s"', 'prime-fashion-magazine'), '<span>' . get_search_query() . '</span>'); ?></p>
                            </header><!-- .page-header -->
