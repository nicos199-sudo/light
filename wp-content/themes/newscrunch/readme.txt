...
@Version 1.8.5.4
* Added custom video block support for featured video section.
...
* Fixed the customizer notify warning.
...
@Version 1.8.4.4
* Added Page title settings on single page for the child theme. 
